...
let cartItemsCh = undefined;
const Checkout = ({ cartItems }) => {
  let cartTotalPrice = 0;
  cartItemsCh = cartItems;
  return (
    <LayoutOne>
      {/* breadcrumb */}
            ...
            <Row>
              ...
              <Col md={6}>
                <div className="order-review space-mt-mobile-only--40">
                  ...
                  <button onClick={() => realizarPedido()}  className="btn btn-fill-out btn-block">
                    Place Order
                  </button>
                </div>
              </Col>
...
const realizarPedido = () =>{
  console.log('Realizar Pedido',cartItemsCh)
}
